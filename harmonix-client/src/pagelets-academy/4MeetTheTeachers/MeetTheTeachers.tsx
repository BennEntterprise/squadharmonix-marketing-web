          ...
          <div className='teachers-container'>
            <div className='teacher-profile'>
              ...
              <p className='bio-text'>
                Laura Saggers hails from an intense background of music
                education with 12 years studying classical piano with the
                Associated Board of the Royals Schools of Music in England to
                completing a Diploma in Vocal Performance and finally, finishing
                her degree in Music Business at the Academy of Contemporary
                Music. Laura has since moved to the US to pursue her career as a
                professional pianist and singer gaining an endorsement with
                Roland keyboards,performing up and down the country at multiple
                venues such at MGM Grand Hotel, the Venetian, headlining at
                Universal Studios for New Years and July 4th to supporting bands
                such as Bow Wow Wow on tour. Laura is an independent
                singer/songwriter who performs weekly in Los Angeles with albums
            ...
            <div className='teacher-profile'>
              ...
              <p className='bio-text'>
                ...
                songwriter from Boston, Massachusetts. He received his
                bachelor’s of music in music business from the Frost School of
                Music at the University of Miami, where he studied music
            ...
            <div className='teacher-profile'>
              ...
              <p className='bio-text'>
                Annie Mauro is a singer, dancer, teacher, choreographer and
                choral arranger originally from Illinois, and she loves working
                with kids in performing arts. She was a competitive dancer with
                Aspire Dance Company in Illinois and also sang with and directed
                Girls Next Door A Cappella, a collegiate female a cappella group
                at the University of Illinois, where she also earned her choral
                music education degree. Upon relocating to Los Angeles in 2016,
                she began her professional teaching career as a K-4 music
                teacher.
              </p>
            </div>
          </div>
        ...
        <Col xs='12' sm='12' md='12' lg='6' xl='6'>
          <div className='teachers-container'>
            <div className='teacher-profile'>
              ...
              />
              <p className='bio-text'>
                Parker Wright was born and raised in Santa Barbara, CA. He has
                been beatboxing and singing professionally for almost 10 years
                and has graduated Cum Laude with a Bachelor in Professional
                Studies from Berklee College of Music. Parker is also an Avid
                Certified Pro Tools Operator. His obsession for singing and
                beatboxing originated from participating in Jazz Choir at high
                school and has developed into a full time career.
                <br />
                <br />
            ...
            <div className='teacher-profile'>
              ...
              />
              <p className='bio-text'>
                Johanna has been passionate about music since she was a toddler.
                At the age of 4 she started playing piano, and has continued for
                12 years training at the Laura Jean Music Academy. She has been
                singing constantly for as long as she can remember, whether it’s
                alone at home, or on the stage. Johanna is currently at her
                school deeply involved in the choir, a cappella groups, and
