...
export interface ITeacherProfile {
  ...
  bio: string
  photo: any
  bannerColor?: 'flower' | 'tortise' | 'lightpurple' | 'tortise' | string
}

const teacherData: Array<ITeacherProfile> = [
  {
    name: 'Laura Saggers',
    title: 'Director/Voice Commander',
    bannerColor: 'flower',
    bio: `hails from an intense
  ...
  {
    name: 'Parker Wright',
    title: 'Beatboxing Commander',
    bio: `was born and raised in Santa Barbara, CA. He has been beatboxing
  ...
  {
    name: 'Christina Martino',
    title: 'Voice Lieutennant',
    bio: `is from Westchester, New York and has been performing, singing
